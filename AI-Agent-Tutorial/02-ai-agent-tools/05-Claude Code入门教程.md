...
详细教程参见：https://www.runoob.com/claude-code/claude-code-tutorial.html
```
...
![alt text](images/05-01-claude-code-01image.png)
...
# 按照提示使用您的账户登录
```
![alt text](images/05-02-claude-code-02image.png)
...
- **ANTHROPIC_MODEL=deepseek-chat**：指定使用 deepseek-chat 模型
- **ANTHROPIC_SMALL_FAST_MODEL=deepseek-chat**：指定使用 deepseek-chat 模型
...
claude
```
![alt text](images/05-02-claude-code-03image.png)
...
![alt text](images/05-02-claude-code-04image.png)
...
![alt text](images/05-02-claude-code-05image.png)
...
![alt text](images/05-04-claude-code-vsplugin-01image.png)

安装完成后，点击右上角 Claude Code 图标，即可进入 Claude Code 页面：

![alt text](images/05-04-claude-code-vsplugin-02image.png)

这样有账号的可以使用 /login 登录：

![alt text](images/05-04-claude-code-vsplugin-03image.png)

也可以在对话框输入 /config 进入设置，勾选 Disable Login Prompt 配置来关闭登录页面:

![alt text](images/05-04-claude-code-vsplugin-04image.png)
