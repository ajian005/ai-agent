...
![alt text](images/07-01-Skills-Agent-01-image.png)
...
![alt text](images/07-01-Skills-Agent-02-image.png)
...
![alt text](images/07-01-Skills-Agent-03-image.png)
...
### 进阶文件结构（技能变复杂时推荐）
当技能超过500–800行，或需要模板/脚本/参考资料时，推荐以下组织方式：
```
...
创建完后文件结构如下：
![alt text](images/07-01-Skills-Agent-04-image.png)
你的项目现在看起来应该是这样的：
```
my-project/
├─ src/
...
![alt text](images/07-01-Skills-Agent-05-image.png)
